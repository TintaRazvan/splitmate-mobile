...
import { View, Text, StyleSheet, TouchableOpacity, Modal, Button, TouchableOpacityProps } from 'react-native';
import { createBottomTabNavigator } from '@react-navigation/bottom-tabs';
import Icon from 'react-native-vector-icons/Ionicons';
import { CameraView, useCameraPermissions } from 'expo-camera';

function GroupsScreen(){ return <View style={styles.screen}><Text style={styles.text}>Groups Page</Text></View>; }
function FriendsScreen(){ return <View style={styles.screen}><Text style={styles.text}>Friends Page</Text></View>; }
function BillsScreen(){ return <View style={styles.screen}><Text style={styles.text}>Bills Page</Text></View>; }
function AccountScreen(){ return <View style={styles.screen}><Text style={styles.text}>Account Page</Text></View>; }
  ...
  return (
    <>
      ...
      >
        ...
        {/* Buton + care NU navighează */}
        <Tab.Screen
  name="Add"
  component={() => null} // nu afișează nimic
  options={{
    tabBarLabel: '',
    tabBarIcon: () => (
      <TouchableOpacity
